...
import { getFirestore, doc, getDoc, setDoc, onSnapshot, arrayUnion } from 'firebase/firestore';
...
export const db = hasFirebaseConfig
  ? getFirestore(initializeApp(firebaseConfig, 'southafrica2010'))
  : null;

export { doc, getDoc, setDoc, onSnapshot, arrayUnion };
